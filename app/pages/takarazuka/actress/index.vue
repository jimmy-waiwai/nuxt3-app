<script setup>
  ...
  const { data: response } = await useFetch(
    `https://jimmy-waiwai.g.kuroco.app/rcms-api/3/takarazuka-actress/301`,
    {
      credentials: 'include',
    }
  );
...
<template>
  <div class="flex justify-center pl-4 lg:pl-8 pr-4 lg:pr-8 pt-20">
    ...
    <div class="flex-1 pl-2 md:pl-8 xl:pl-16 pr-2 md:pr-8 xl:pr-16 pb-16">
      <div class="pt-8">
        <h2 class="text-pink-900 font-bold text-2xl sm:text-3xl md:text-4xl klee-one mb-4" v-text="response.details.subject"></h2>
